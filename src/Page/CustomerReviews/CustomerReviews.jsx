    ...
    <div className="customer-reviews py-16 px-5 bg-gray-100 my-20">
      <div className="container mx-auto text-center">
        ...
        <p className="text-lg mb-12">
          Hear from some of our happy clients who have successfully applied for
          their visas.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-10">
          <div className="review-card bg-white p-6 shadow-lg rounded-lg w-80">
            <p className="text-gray-700 mb-4">
              "I had an amazing experience applying for my visa. The process was
              quick, and the support team was really helpful throughout!"
            </p>
